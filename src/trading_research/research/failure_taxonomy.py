...
CODE_TOKEN_RESERVATION_RECONCILIATION_REQUIRED = "TOKEN_RESERVATION_RECONCILIATION_REQUIRED"
CODE_TOKEN_RESERVATION_STATE_CONFLICT = "TOKEN_RESERVATION_STATE_CONFLICT"
CODE_TOKEN_USAGE_EVIDENCE_REQUIRED = "TOKEN_USAGE_EVIDENCE_REQUIRED"
CODE_TOKEN_ACCOUNTING_POLICY_MISMATCH = "TOKEN_ACCOUNTING_POLICY_MISMATCH"
...
CODES = (
    ...
    CODE_TOKEN_RESERVATION_RECONCILIATION_REQUIRED,
    CODE_TOKEN_RESERVATION_STATE_CONFLICT,
    CODE_TOKEN_USAGE_EVIDENCE_REQUIRED,
    CODE_TOKEN_ACCOUNTING_POLICY_MISMATCH,
