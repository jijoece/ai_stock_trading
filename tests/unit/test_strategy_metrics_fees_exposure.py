...
from trading_research.strategies.strategy_metrics import compute_strategy_metrics


def _fill(fill_id, order_id, side, symbol, quantity, price, fees, market_date, exit_reason=None):
    return BacktestFill(
